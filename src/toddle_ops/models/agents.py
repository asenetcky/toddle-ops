...
class AgentInstructions(BaseModel):
    ...
    persona: Annotated[
        str, Field(default="helpful assistant", description="The persona of the agent.")
    ]
    primary_objective: Annotated[
        list[str], Field(description="The primary objectives of the agent.")
    ]
    rules: Annotated[
        list[str] | None,
        Field(default_factory=list, description="The rules the agent must follow."),
    ]
    constraints: Annotated[
        list[str] | None,
        Field(
            default_factory=list, description="The constraints the agent must follow."
        ),
    ]
    incoming_keys: Annotated[
        list[str] | None,
        Field(
            default_factory=list,
            description="The incoming keys the agent will receive.",
        ),
    ]
